...
* **Integrations & Security:** Stripe Connect, Firebase Cloud Messaging, Laravel Sanctum
* **Testing & Tools:** Postman, Pest, k6, Git, GitHub
...
* Deep learning computer vision models (V10 & V12) designed for agricultural plant disease detection.
